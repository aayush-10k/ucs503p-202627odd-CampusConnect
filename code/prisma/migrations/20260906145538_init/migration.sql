...
-- CreateEnum
CREATE TYPE "GroupType" AS ENUM ('SUBJECT', 'BATCH', 'LAB', 'CLUB');

-- CreateEnum
CREATE TYPE "GroupMemberRole" AS ENUM ('ADMIN', 'MEMBER');

-- CreateEnum
CREATE TYPE "EventType" AS ENUM ('LECTURE', 'EXAM', 'ASSIGNMENT', 'REMINDER', 'OTHER');

-- CreateEnum
CREATE TYPE "FriendRequestStatus" AS ENUM ('PENDING', 'ACCEPTED', 'REJECTED');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('FRIEND_REQUEST', 'FRIEND_ACCEPTED', 'POST_LIKE', 'POST_COMMENT', 'GROUP_INVITE', 'NEW_MESSAGE', 'NEW_EVENT', 'MODERATION_FLAG');
...
CREATE TABLE "Group" (
    ...
    "name" TEXT NOT NULL,
    "description" TEXT,
    "type" "GroupType" NOT NULL DEFAULT 'SUBJECT',
...
-- AddForeignKey
ALTER TABLE "ModerationReport" ADD CONSTRAINT "ModerationReport_postId_fkey" FOREIGN KEY ("postId") REFERENCES "Post"("id") ON DELETE CASCADE ON UPDATE CASCADE;
